...
After it's running, you can hit the url with: 
http://localhost:3000/token?email=test@gmail.com

to get a token, as an example.
...
just the email.  jwt library was selected for simplicity, but I am not as familiar w/ the library integrity.
Would likely use auth0 (https://github.com/auth0/node-jsonwebtoken) instead, but it's more compliated.
